%% MATLAB code to recognise which pattern is present images in File 3

imds = imageDatastore('File3\challenging\', ...
...
options = trainingOptions('sgdm', ... % use gradient decsent (with momentum)
    'MiniBatchSize',20, ... % number of images used per mini-batch
